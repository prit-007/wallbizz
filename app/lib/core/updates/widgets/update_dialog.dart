...
class _UpdateDialogState extends State<UpdateDialog> {
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Icon(Icons.system_update_rounded, color: cs.primary, size: 32),
                ...
                Row(
                  ...
                  children: [
                    ...
                    _versionPill('Latest', _info.latestVersion.toString(), vk, isHighlighted: true),
                  ],
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 8),
                        ...(_info.changelogLines.take(5).map((line) => Padding(
                ...
                if (_error != null) ...[
                  ...
                  Text(_error!, style: GoogleFonts.inter(color: cs.error, fontSize: 12)),
                ],
                    ...
                    Expanded(
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Text('LATER', style: GoogleFonts.inter(color: vk.onSurfaceSubtle, fontWeight: FontWeight.bold, letterSpacing: 1)),
                          ),
                        ),
                      ),
                    ),
                    ...
                    Expanded(
                      child: GestureDetector(
                        onTap: _isDownloading
                            ? null
                            : (_info.apkUrl != null ? _downloadAndInstall : _openReleasePage),
                        child: Container(
                          padding: const EdgeInsets.symmetric(vertical: 14),
                          decoration: BoxDecoration(
                            color: cs.primary,
                          ...
                          child: Center(
                            child: Text(
                              _info.apkUrl != null ? 'UPDATE' : 'VIEW RELEASE',
  ...
  Widget _versionPill(String label, String version, dynamic vk, {bool isHighlighted = false}) {
    return Column(
      children: [
        Text(
          label,
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: isHighlighted ? Theme.of(context).colorScheme.primary.withValues(alpha: 0.2) : Colors.white.withValues(alpha: 0.05),
            borderRadius: BorderRadius.circular(8),
            border: Border.all(
              color: isHighlighted ? Theme.of(context).colorScheme.primary : Colors.white.withValues(alpha: 0.1),
            ),
          ),
          child: Text(
            'v$version',
